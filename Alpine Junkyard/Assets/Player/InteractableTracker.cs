...
{
    [SerializeField] private List<SceneObject> interactableSceneObjects = new List<SceneObject>();
    ...
    private void OnTriggerEnter(Collider collider)
    {
        ...
        if (sceneObject != null && !this.interactableSceneObjects.Contains(sceneObject))
        {
